...
function EditProfile() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const response = await axios.patch(`http://localhost:5000/api/user/${id}`, profileData, {
        ...
        <div className="container">
          ...
          <form className="vertical-form" onSubmit={handleSubmit}>
            ...
            <input
              ...
              placeholder={age}
            />
            <button variant="primary" type="submit">Save Changes To Profile</button>
            <br>
            </br>
            <button variant="danger" type="submit" onClick={handleDelete} >Delete Profile</button>
          </form>
          </>
        )}
        </div>
